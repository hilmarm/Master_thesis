...
TEST_F(IntersectedCellsTest, find_point_test) {
    ...
    QVector3D *start_point = new QVector3D(0,0,1712);
    QVector3D *end_point = new QVector3D(25,25,1712);
    QVector3D *exit_point = new QVector3D(24,24,1712);
    std::cout << "find exit point test"<<std::endl;
...
TEST_F(IntersectedCellsTest, intersected_cell_test_cases) {
    ...
    QVector3D *start_point = new QVector3D(0,0,1702);
    QVector3D *end_point = new QVector3D(44,84,1720);
...
TEST_F(IntersectedCellsTest, point_inside_cell_test) {
    ...
    QVector3D *point_0 = new QVector3D(0,0,1700);
    QVector3D *point_1 = new QVector3D(12,12,1712);
    QVector3D *point_2 = new QVector3D(24,12,1712);
